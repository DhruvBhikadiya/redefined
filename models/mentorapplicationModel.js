...
const mentorapplication = {
    ...
    findByPhone: async (phone) => {
        const sql = 'SELECT id, phone FROM mentorapplication WHERE phone = ?';
        try {
